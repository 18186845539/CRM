...
<html>
	...
	<body bgcolor="#F3F3F3">
        ...
        <img alt="logo" src="1.png" style="width:250px;height:150px;margin-left:765px;margin-top:0px" float="left"> 
		<div style="background:#FFFFFF;width:500px;height:570px;position:absolute;left:630px;top:160px">
			<form action="./login" method="post">
				...
				<center><img alt="用户名" src="username.jpg" style="vertical-align:bottom" /><input type="text" name="username" placeholder="用户名/邮箱/手机号" size="50px" style="height:50px;vertical-align:bottom" /></center>
				<br>
				<center><img alt="密码" src="password.jpg" style="vertical-align:bottom" /><input type="password" name="password" placeholder="密码" size="50px" style="height:50px;vertical-align:bottom" /></center><br><br>
